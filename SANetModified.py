from keras.layers import Conv2D, MaxPooling2D, concatenate, Input, Dense, Conv2DTranspose, ReLU, UpSampling2D, Activation, Add # Add
...
def SANetModified(input_shape=(None, None, 3), IN=True):
    ...
    x_2 = Activation('relu')(x_2)
    x_2 = InstanceNormalization()(x_2) if IN else x_2
    res_3 = x_2 # new, had to pull from a different spot because the channels didn't match for this module
